...
<body>
    <div class="container">
        <div
            style="background-color: #ffffff;width: 74.3%;height: 7%;position: fixed; border-radius: 15px;margin-top:5px ;display:flex;z-index: +1;margin-left: 11px">
            <h3
        ...
        <div style="margin-top: 105px;">
            ...
            <div class="logo" style=" display: flex;gap: 12px;margin-right: -12px;">
                <div>
                <a href="/business/create"><i class="fa-solid fa-plus"></i></a>
                </div>
                <div>
                    <a href="/business/trash">Go-To-Bin</a>
                </div>
            </div>
                    ...
                    @foreach ($businesss as $business)
                        <tr>
                            ...
                            <td class="action-icons">
                                <a href="{{ url('/business/edit/') }}/{{ $business->id }}"><i
                                        class="fa-regular fa-pen-to-square" style="color: blue;"></i></a>
                                <a href="{{ url('/business/delete/') }}/{{ $business->id }}"><i
