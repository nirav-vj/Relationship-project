...
<body>
    ...
    <div class="container">
        <div
            style="background-color: #ffffff;width: 74.5%;height: 7%;position: fixed; border-radius: 15px;top:30px ;display:flex;z-index: +1;">
            <h3
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="action-icons">
                                <a href="{{ url('/user/restore/') }}/{{ $user->id }}"><i
                                        class="fa-solid fa-arrows-rotate" style="color: blue;"></i></a>
                                <a href="{{ url('/user/force-delete/') }}/{{ $user->id }}"><i class="fa-solid fa-trash"
                                        style="color: red;"></i></a>
                            </td>
                        </tr>
                        <?php $i++; ?>
